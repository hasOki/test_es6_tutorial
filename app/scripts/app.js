System.register("app.es6", [], function() {
  "use strict";
  var __moduleName = "app.es6";
  ...
  function greet(greeting) {
    var name = arguments[1] !== (void 0) ? arguments[1] : 'John';
    console.log(greeting + ', ' + name);
  }
  greetNoDefault();
  greet();
  ...
  greet('Hello', 'Bill');
  function receive() {
    var complete = arguments[0] !== (void 0) ? arguments[0] : (function() {
  ...
  var $__9 = $traceurRuntime.assertObject(returnSomething()),
      name = $__9.last_name,
      state = $__9.state;
  console.log(name);
  console.log(state);
  ...
  people.forEach((function($__9) {
    var first_name = $traceurRuntime.assertObject($__9).first_name;
  ...
  var positions = (function() {
    ...
    for (var $__6 = people[$traceurRuntime.toProperty(Symbol.iterator)](),
      ...
      try {
        ...
        position = $traceurRuntime.assertObject($__7.value).position;
      ...
      try {
        ...
        try {
          ...
          try {
            ...
            {
              $__9 = $traceurRuntime.assertObject($__7.value);
              position = $__9.position;
              last_name = $__9.last_name;
            }
